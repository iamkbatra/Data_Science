...
#read the absorption energies/wavelengths dataset for various organic dyes
...
#calculate the scaled absorption energies error dataset for all the functionals w.r.t experimental
